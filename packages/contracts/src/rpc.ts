...
const WsProviderEphemeralQueryRpc = Rpc.make(WS_METHODS.providerEphemeralQuery, {
...
const WsOrchestrationKillSubagentRpc = Rpc.make(ORCHESTRATION_WS_METHODS.killSubagent, {
